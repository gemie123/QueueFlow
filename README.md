...
The companies main database structure as seen below consists of four tables: call , agent, agent_shift, queue, csat a total row count of 98,324 records. A description of each table is as follows:
...
<img src="images/Exec_dash_1.png" width="1200">
...
#### 3. Rebalance off-peak staffing and routing logic to reduce wait-time volatility during low-utilization hours, where delays stem from timing and assignment inefficiencies rather than capacity shortages.
